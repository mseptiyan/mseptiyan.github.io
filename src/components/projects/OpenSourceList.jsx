    ...
    <section className="py-16 px-6 md:px-12 border-t border-border">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-8 space-y-3">
          {repos.map((repo, i) => {
            const Wrapper = repo.url ? 'a' : 'div';
            const wrapperProps = repo.url
            ...
            return (
              <Wrapper key={i} {...wrapperProps}>
                ...
                >
                  ...
                  <ExternalLink className={`w-4 h-4 shrink-0 mt-1 transition-colors ${repo.url ? 'text-muted-foreground/30 group-hover:text-primary' : 'text-muted-foreground/15'}`} />
                </motion.div>
              </Wrapper>
            );
          })}
